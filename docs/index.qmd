 ...
 * For further technical details, see the [development notebooks](https://github.com/NIVANorge/lake_liming_app/tree/main/notebooks#development-notebooks). The model code is also Open Source and [available on GitHub](https://github.com/NIVANorge/lake_liming_app).