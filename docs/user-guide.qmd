...
Fanen `Innsjømodellering` er hovedsiden til applikasjonen og er delt inn i fire seksjoner: `Kalkingsprodukter`, `Innsjøegenskaper`, `Kalkingsparametere` og `Modellresultater`. Under hver overskrift finner du utvidbare «Hjelp»-bokser som gir tips for hvordan du bruker appen.

### Kalkingsprodukter {#sec-liming-products}

Velg ditt produkt av interesse ved å bruke rullegardinlisten merket `Velg kalkingsprodukt`. Appen vil vise plott av momentanoppløsning og overdoseringsfaktorer basert på de siste kolonnetestdataene i databasen. Klikk på ellipseknappen (`[...]`) som vises øverst til høyre i plottområdet for å eksportere plottene i PNG- eller SVG-format (@fig-column-test-results).
