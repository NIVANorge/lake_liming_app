...
Differences between products on these plots reflect the different physical and chemical properties of the limes, as represented by the [column test](https://nivanorge.github.io/lake_liming_app/column-tests.html) data.
