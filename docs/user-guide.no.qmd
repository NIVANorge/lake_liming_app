...
See the [Column tests](https://nivanorge.github.io/lake_liming_app/column-tests.html) page for a detailed description of the laboratory tests on which these plots are based.
...
Se siden [Kolonnetester](https://nivanorge.github.io/lake_liming_app/column-tests.no.html) for en detaljert beskrivelse av laboratorietestene som disse plottene er basert på.
...
Forskjeller mellom produktene på disse plottene gjenspeiler de forskjellige fysiske og kjemiske egenskapene til kalkene, som representert av [kolonnetestdataene](https://nivanorge.github.io/lake_liming_app/column-tests.no.html).
