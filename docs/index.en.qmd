 ...
 * To understand how the model works, see [Lake modelling](https://nivanorge.github.io/lake_liming_app/lake-modelling.en.html).

 * For details of the empirical data used to represent different lime products, see [Column tests](https://nivanorge.github.io/lake_liming_app/column-tests.en.html).
