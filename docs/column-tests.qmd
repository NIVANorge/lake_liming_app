...
: Experimental design for typical column test. Each `x` coresponds to a single column for which instantaneous dissolution is determined. {#tbl-expt-design}
