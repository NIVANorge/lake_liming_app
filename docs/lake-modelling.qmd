...
|             |- CaCO3-ekv (%)|        52.7 |     1.2 |
+-------------+---------------+-------------+---------+
|**NV** (sum of CaCO3-ekv; %) |       106.4 |   100.2 |
+-------------+---------------+-------------+---------+

: Estimating the **neutralising value** (NV) for two different lime products. $MgCO_3$ content is converted to $CaCO_3$-equivalents by multiplying by 1.187. {#tbl-nv}
